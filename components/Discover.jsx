...
const Discover = () => {
  return (
    <motion.section variants={staggerContainer()} initial="hidden" whileInView="show" viewport={{once:true, amount:0.25}} className={`${styles.padding} max-w-7xl mx-auto relative z-0`} >
      ...
      <motion.div className='w-full flex justify-center items-center my-12'>
            <h2 className={`${styles.sectionHeadText} text-[50px]`}>Discover the latest in ...</h2>
        </motion.div>
      <div className='w-full flex flex-row justify-between mt-12'>
        <motion.div>
            <h2 className={`${styles.sectionHeadText} text-6xl`}>Ideations</h2>
        </motion.div>
      ...
      <div className='mt-20 flex flex-wrap gap-7 my-8'>
      ...
      <div className='w-full flex flex-row justify-between mt-12'>
        <motion.div>
            <h2 className={`${styles.sectionHeadText} text-6xl`}>New in Tech</h2>
        </motion.div>
        <motion.a variants={fadeIn("","",0.1, 1)} className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
        View All Posts
        </motion.a>
      ...
      <div className='w-full flex flex-row justify-between mt-12'>
        <motion.div>
            <h2 className={`${styles.sectionHeadText} text-6xl`}>What Am I Up To?</h2>
        </motion.div>
        <motion.a variants={fadeIn("","",0.1, 1)} className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
        View All Posts
        </motion.a>
      ...
      <div className='w-full flex flex-row justify-between mt-12'>
        <motion.div>
            <h2 className={`${styles.sectionHeadText} text-6xl`}>New Business & Startups</h2>
        </motion.div>
        <motion.a variants={fadeIn("","",0.1, 1)} className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
        View All Posts
        </motion.a>
